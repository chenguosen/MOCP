...
def getRedisConn(hostIp, port, isCluster, passwd=None):
    if isCluster == '1':
        ...
        startup_nodes = [{'host': '10.12.8.200', 'port': 7000}, {'host': '10.12.8.200', 'port': 7001}, {'host': '10.12.8.200', 'port': 7002}, {
            'host': '10.12.8.201', 'port': 7003}, {'host': '10.12.8.201', 'port': 7004}, {'host': '10.12.8.201', 'port': 7005}]
...
def zaddOne(hostIp, port, isCluster, passwd, key, score, value):
    """设置一条有序集合类型的值
    """
    redisConn = getRedisConn(hostIp, port, isCluster, passwd)
...
if __name__ == "__main__":
    ...
    hostIp = u'10.12.8.201'
    port = u'7004'
    isCluster = '1'
    name = 'mm_tnc'
    key = 'KEY_PRELICENSE_BALANCE_2000010017001'
    value = '100'

    print(getStringByKey(hostIp, port, isCluster, name, key))
    zaddOne(hostIp, port, isCluster, name, 'KEY_APP_PRELICENSE_ORDERS_100000000200',1,2000010023002)
